...
<?php include_once("includes/head.php"); ?>
    <body class="bg-primary" style="background-color: #04af7394 !important;">
                ...
                <main>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5" style="    background-color: #a1444400;box-shadow: 0px 5px 25px black !important;">
                                 
                                <div class="card-header"><h3 class="text-center font-weight-light my-4"><i class="fa-regular fa-circle-user"></i> User Login</h3></div>
                                    <div class="card-body">
